...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        if ai_settings.bullet_width == 3000:
            ai_settings.bullet_width = 3
        else:
            ai_settings.bullet_width = 3000
    elif event.key == pygame.K_p:
        ai_settings.bullet_power = 1 - ai_settings.bullet_power
    elif event.key == pygame.K_o:
        ai_settings.bullet_auto = 1- ai_settings.bullet_auto
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, 
    ...
    collisions = pygame.sprite.groupcollide(bullets, aliens, 
                        (1-ai_settings.bullet_power), True)
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    check_aliens_botom(ai_settings, screen, stats, sb, ship, aliens, bullets)
...
def check_aliens_botom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """检查是否有外星人到达了屏幕底端"""
